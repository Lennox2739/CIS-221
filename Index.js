function refreshWeather(currentweather){
    ...
    //this is a shorter way of doing the exact same thing commented codes do.
    ...
    currentWeatherIcon.innerHTML=`<img src=${currentweather.data.condition.icon_url}"
    alt="not loading"
...
function searchCity(curentcityName)
{
